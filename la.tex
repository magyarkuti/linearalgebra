...
\usepackage[backend=biber,bibencoding=utf8,style=authoryear,autocite=inline]{biblatex}
...
\chapter*{Előszó}
\scwords%
A legfontosabb forrás \cite{DancsPuskas2001}.
...
\footnote{Karakterizációjukat lásd: \cite{MR1415833}-ben.}
...
\begin{definition}[mátrix rangja]\index{mátrix rangja}
    ...
    ezért a továbbiakban a közös értékre a \emph{rang} szót is használjuk.\footnote{Lásd: \cite{Wardlaw2005}}
\end{definition}
\begin{note}
...
\begin{proof}
    ...
    \footnote{%
        A feszítőrang fogalmának ismerete nélküli -- talán még elemibb -- bizonyítás: \cite{doi:10.4169/college.math.j.48.5.366}%
    }%
\end{proof}
...
Az algebra alaptétele, és a komplex számtest egyértelműsége. Elsősorban \cite{MR1415833} és \cite{10.2307/3647746} alapján
...
Last Modified : Sun 22 Sep 2019 02:23:01 PM CEST
