...
\begin{definition}[lineáris operátor]
    ...
    A $V=W$ esetben a rövidség kedvért csal $L\left( V \right)$-t írunk.
\end{definition}
...
\end{definition}
\begin{proposition}
    Minden $\mathbb{F}$ test feletti véges dimenziós $V$ vektortér izomorf az $\mathbb{F}^{\dim V}$
    koordináta térrel.
\end{proposition}
...
\begin{proposition}
    Legyenek az $M_1,\dots,M_s\subseteq V$ alterek megadva.
...
\begin{proof}
    ...
    ergo valamely $1<t\leq s$ mellett találtunk az $M_t\cap\left( \sum_{j=1}^{t-1} \right)$
...
Last Modified : Sat 16 Nov 2019 11:47:08 PM CET
