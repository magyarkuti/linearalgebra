...
\begin{definition}
    ...
    Tudjuk, hogy az $\mathbb{F}\left[ t \right]$ polinomgyűrű egy főideálgyűrű,
...
\begin{definition}
    ...
    \emph{minimál polinomjának}\index{minimál polinom}.
\end{definition}
Ha $V\neq\left\{ 0 \right\}$, ergo $\dim V\geq 1$,
akkor a $J_{A}$ ideálnak nincs nulladfokú polinomja, 
hiszen $p(t)=c, (c\neq 0)$ mellett
$p\left( A \right)=cI\neq 0$, tehát a minimál polinom legalább első fokú.


\begin{proposition}
Ha  $m$ az $A$ transzformáció minimál polinomja,
akkor
\begin{enumerate}
...
\end{proof}
Néha kényelmesebb az kis minimál polinomokkat használni a minimál polinom meghatározására.
\begin{proposition}
    Legyen az $A\in L\left( V \right)$ lineáris transzformáció minimál polinomja $m$.
    Tegyük fel, hogy az $\left\{ e_1,\dots,e_n \right\}$ bázisa $V$-nek,
    és $p_1,\dots,p_n$ rendre a bázis elemekhez tartozó kis minimál polinomok.
    Ekkor a $p_1,\dots,p_n$ polinom legkisebb közös többszöröse $m$.
\end{proposition}
\begin{proposition}
...
Last Modified : Sun 09 Feb 2020 11:13:49 PM CET
