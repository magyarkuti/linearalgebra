...
Az $m\times n$ méretű mátrixok $\mathbb{F}^{m\times n}$ halmaza a mátrixösszeadással és a számmal való szorzással
...
hogy $\mathbb{F}^X$ egy az $\mathbb{F}$ test feletti vektortér.
...
\(
    a\#b=a\cdot b, \alpha\star a=a^\alpha.
\)
...
Last Modified : Fri 27 Sep 2019 12:28:13 PM CEST
