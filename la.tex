...
\scwords Az alterek struktúrát vizsgáljuk a fejezetben.
...
\begin{proposition}\index{altér direkt kiegészítője}
...
\end{definition}
    ...
    ami azt jelenti, hogy $V=\cup_{x\in V}M_x$, és ha valamely $x,y\in V$ mellett $M_x\cap M_y\neq\emptyset$,
    akkor $M_x=M_y$.
    ...
    Legyen $\ast$ a $V$ vektortér elemein értelmzett reláció,
    amelyre $x\ast y$, ha $x-y\in M$ ekvivalencia reláció.
...
\begin{proof}
    ...
    Az ekvivalencia osztályok közt is van neutrális elem,
    ...
    \end{enumerate}
    Ez utóbbi az $M_x+M_{-x}=M_{x+\left( -x \right)}=M_0=M$ azonosság miatt teljesül, 
...
Last Modified : Sun 01 Dec 2019 09:09:24 AM CET
