...
\frenchspacing
\usepackage{csquotes,amsmath,amsthm,amsfonts,amssymb,fixme}
...
hogy $F^X$ egy $\mathbf{F}$ feletti vektortér.
...
Egyrészt használjuk majd a Steinitz-lemma (\ref{le:Stienitz}) igazolásában, 
...
\end{proof}
\section{Elimináció}
Szokásos jelölés és a helyes szemlélet kialakítsában is fontos szerepet játszik a következő táblázat.
...
\begin{eqnarray*}
    ...
    \begin{array}{c|cccc}
        ...
        \vdots      &\vdots &\vdots &\vdots &\vdots    \\
        x_m         &0  &\alpha_m-\eta_m\delta_a&\beta_m-\eta_m\delta_b&\gamma_m-\eta_m\delta_m   \\
        \hline
       &&
    \end{array}
\end{eqnarray*}
...
Hasonlóan, az $m$-edik sor az eredeti $m$-edik sornak és a segédsor $\eta_m$-szeresének különbsége.
\end{itemize}
...
\scwords A Steinitz-lemma fontosságát kell kiemelni, amely 
a legegyszerűbb megfogalmazásában azt állítja, 
...
A Stienitz-lemma megfogalmazása előtt emlékezzünk a generátorrendszer cseréjére vonatkozó \aref{le:gencsere} lemmára.
\begin{SL}\index{Steinitz--lemma}
    Tegyük fel, hogy az $\left\{ y_1,\dots,y_n \right\}$ egy lineárisan független rendszer és az
    $\left\{ x_1,\dots,x_m \right\}$ vektorrendszer egy generátorrendszer.
    Ekkor
    \begin{enumerate}
        \item $n\leq m$;
...
Last Modified : Tue 08 Oct 2019 10:51:08 AM CEST
