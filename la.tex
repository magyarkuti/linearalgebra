...
Ezeket az oszlopokat egy $A_1\in\mathbf{F}^{n\times r}$ mátrixba rendezve az $A$ oszlopvektortének
egy generátorrendszerét kapjuk, 
így létezik $A_2\in\mathbf{F}^{r\times m}$ mátrix, amelyre $A_1A_2=A$ teljesül.
\section{Dimenzió}
...
Last Modified : Sun 15 Dec 2019 09:19:24 AM CET
