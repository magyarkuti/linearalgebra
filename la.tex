...
\begin{proposition}
    ...
    \[
        \left[ A \right]_{\uj}=
        \left[ B \right]_{\rgi}^{-1}\left[ A \right]_{\rgi}\left[ D \right]_{\rgi}.\qedhere
    \]
\end{proposition}
\begin{proof}
...
\begin{proof}
    ...
    így $\ker q\left( A \right)+\ker p\left( A \right)=V$ valóban fennáll.

    Megmutattuk tehát, hogy $V$ előáll min a $\ker p\left( A \right)$ és a 
...
\begin{proposition}
    ...
    Jelölje $V_i=\ker p^{m_i}\left( A \right)$ 
...
Last Modified : Mon 17 Feb 2020 07:17:53 PM CET
