...
\begin{definition}
    ...
    Az $A:V\to W$ függvényt lineáris operációnak mondjuk,
    \begin{displaymath}
...
Hasonlóan ha most $x\in\mathbf{F}^m$ sorvektort jelöl akkor az
\[
    x\mapsto x\cdot A
\]
...
Ennek inverze az $x\mapsto A^{-1}x$ operátor,
ahol $A^{-1}$ az inverz métrixot jelöli.

\begin{definition}
    Egy $A:V\to W$ függvényt \emph{izomorfizmusnak}\index{izomorfizmus} mondunk,
    ha $A$ lineáris bijekció.
    Az ugyanazon test feletti $V,W$ vekotortereket egymással izomorf vektortérnek mondjuk,
...
Last Modified : Tue 12 Nov 2019 07:12:33 PM CET
