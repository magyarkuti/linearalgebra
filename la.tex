...
\scwords Kitérőnek is tekinthetjük a fejezetet.
\begin{proposition}
    ...
    \begin{enumerate}
        ...
        \item
            ...
            vagy $k$ dimenziós,
            vagy $k$ dimenziós $A$ invariáns alterek dirketösszege.\qedhere
    \end{enumerate}
\end{proposition}
...
Világos, hogy $p\left( A_1 \right)=0\in L\left( V_1 \right)$, ezért alkalmazhatjuk a fent igazolt tételt
...
\begin{proposition}
    ...
    \begin{enumerate}
        ...
        \item a $\ker p\left( A \right)$ altér nulla dimenziós,
            vagy $k$ dimenziós, vagy $k$ dimenziós invariáns alterek direktösszege.\qedhere
    \end{enumerate}
\end{proposition}
...
Last Modified : Tue 25 Feb 2020 08:04:32 PM CET
