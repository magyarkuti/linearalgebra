...
\begin{proof}
    ...
    \[
        A\left( BA-I \right)=A\left( BA \right)-A=\left( AB \right)A-A=IA-A=A-A=0.
    \]
    Namost, ha $BA\neq I$ lenne, akkor a $BA-I$ mátrixnak lenne egy nem zérus oszlopa, 
    úgy, hogy ez oszlop elemeivel mint együtthatókkal képzett lineáris kombinációja az $A$ mátrix oszlopainak 
...
Last Modified : Wed 31 Jul 2019 04:05:54 PM CEST
