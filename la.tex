...
\frenchspacing
\usepackage{amsmath,amsthm,amsfonts,fixme,natbib}
...
\theoremstyle{plain}
\newtheorem{propositionx}{állítás}[chapter]
\newenvironment{proposition}
    {\pushQED{\qed}\renewcommand{\qedsymbol}{$\Diamond$}\propositionx}
    {\popQED\endpropositionx}
\newtheorem{lemma}[propositionx]{lemma}
\newtheorem*{SL}{Steinitz-lemma}
%
\theoremstyle{remark}
\newtheorem{note}[propositionx]{megjegyzés}

\theoremstyle{definition}
\newtheorem{definition}[propositionx]{definíció}
\newtheorem{corollary}[propositionx]{következmény}
...
\begin{proposition}
    ...
    \begin{enumerate}
        ...
        \item A vektorrendszer egyszerre lineárisan független és generátorrendszer.\qedhere
    \end{enumerate}
\end{proposition}
...
Last Modified : Tue 23 Jul 2019 06:54:25 PM CEST
