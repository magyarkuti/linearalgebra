...
\]
\begin{definition}[generátor rendszer, végesen generált vektortér]\index{generátor rendszer}\index{végesen generált vektortér}
    Egy vektortér $H$ részhalmazáról azt mondjuk, hogy generálja a vektorteret,
    vagy, hogy $H$ egy generátor rendszere $V$-nek, ha $\lin H=V$.
    A $V$ vektorteret végesen generáltnak mondunk, ha létezik véges generátor rendszere.
\end{definition}
...
Last Modified : Sun 29 Sep 2019 09:05:30 AM CEST
