...
\begin{proposition}
    ...
    \begin{enumerate}
        \item $A$ injektív;
        \item $A$ szürjektív;
        \item $A$ vektortér--izomorfizmus.\qedhere
    \end{enumerate}
\end{proposition}
...
\begin{proof}
    ...
    \[
        \gamma_{i,j}=\sum_{k=1}^r\alpha_{i,k}\beta_{k,j}.
    \]
    Ezt kellett belátni. 
\end{proof}
...
A jelölést a szóhasználat is követi avval, hogy a lineáris operátorok kompozícióját időnként szorzatnak is mondjuk.
Ilyen módon ha $A$ és $B$ két olyan lineáris operátor, amelynek kompozíciója -- azaz szorzata -- értelmes,
...
Last Modified : Wed 05 Feb 2020 10:50:44 AM CET
