...
A koordinátatér fogalmát vezetjük be. Látni fogjuk, hogy véges dimenziós vektortér ,,lényegében'' az egyetlen példa,
az $\mathbb{F}^n$ tér.
\begin{definition}
...
\]
\begin{proposition}
    Egy lineáris leképezés pontosan akkor injrktív, ha $\ker A=\left\{ 0 \right\}$.
...
\end{proposition}
Néhetünk az $A$ mátrixra mint $x\mapsto A\cdot x$ lineáris operátorra.
Ennek inverze
...
Last Modified : Mon 11 Nov 2019 12:53:48 PM CET
