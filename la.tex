...
\begin{proposition}
    ...
    ahol $b_j\in\mathbb{F}^n$ oszlop vektorok és $c_j\mathbb{F}^m$ sor vektorok.
    Ekkor a $\left\{ b_j:j=1,\dots,r \right\}$ oszloprendszer is lineárisan független rendszer,
    és a $\left\{ c_j:j=1,\dots,r \right\}$ sorrendszer is lineárisan független rendszer.
\end{proposition}
\begin{proof}
    Legyen a $B$ mátrix $b_j$ és a $C$ mátrix $j$-edik sora $c_j$.
...
Last Modified : Sun 15 Dec 2019 04:31:54 PM CET
